...
public class VIndex extends javax.swing.JFrame {
    ...
    public VIndex(NUsuario modeloUsuario) {
        initComponents();
...
//        this.dispose();
    ...
    private void btnUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUsuarioActionPerformed
        // TODO add your handling code here:
        new CUsuario(usuario.datosUsuario().getIdCargo());
//        this.dispose();
...
//        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VIndex.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
